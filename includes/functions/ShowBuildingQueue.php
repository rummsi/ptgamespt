			...
			if ($BuildEndTime >= $CurrentTime) {
				...
				if ($ListID > 0) {
					...
					if ($ListID == 1) {
						...
						$ListIDRow .= "		<a href=\"game.php?page=BatimentBuildingPage&listid=". $ListID ."&amp;cmd=cancel&amp;planet=". $PlanetID ."\">". $lang['DelFirstQueue'] ."</a></div>";
						...
						$ListIDRow .= "		<a href=\"game.php?page=BatimentBuildingPage&listid=". $ListID ."&amp;cmd=remove&amp;planet=". $PlanetID ."\">". $lang['DelFromQueue'] ."</a></font>";
					}
					$ListIDRow .= "	</td>";
					$ListIDRow .= "</tr>";
				}

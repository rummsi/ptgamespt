...
switch ($mode) {
    ...
    default:
        if ($user['id'] != '') {
            ...
            $Record = 0;
            while ($FleetRow = mysqli_fetch_array($OwnFleets, MYSQLI_ASSOC)) {
                $Record++;
            ...
            $Record = 2000;
            while ($FleetRow = mysqli_fetch_array($OtherFleets, MYSQLI_ASSOC)) {
            ...
            $Colone = 1;
            $AllPlanets = "<tr>";
            while ($UserPlanet = mysqli_fetch_array($planets_query, MYSQLI_ASSOC)) {
            ...
            $Record = 4000;
            while ($irak = mysqli_fetch_array ($iraks_query, MYSQLI_ASSOC)) {
                $Record++;
                $fpage[$irak['zeit']] = '';
